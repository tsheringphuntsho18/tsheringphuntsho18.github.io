...
![htb](/assets/SWS_pictures/htb1.png)

Task 2

![htb](/assets/SWS_pictures/htb2.png)

Task 3

![htb](/assets/SWS_pictures/htb3.png)
...
![htb](/assets/SWS_pictures/htb4.png)

Task 5

![htb](/assets/SWS_pictures/htb5.png)

Task 6: What service do we identify on port 23/tcp during our scans?

Ans: telnet

![htb](/assets/SWS_pictures/htb6.png)
...
![htb](/assets/SWS_pictures/htbf1.png)

Task 2: Which port does the FTP service listen on usually?

![htb](/assets/SWS_pictures/htbf2n5.png)
...
![htb](/assets/SWS_pictures/htbf4.png)
...
![htb](/assets/SWS_pictures/htbf6.png)

Ans: Unix

Task 7

![htb](/assets/SWS_pictures/htbf8.png)
...
![htb](/assets/SWS_pictures/htbf9.png)
...
![htb](/assets/SWS_pictures/htbf10.png)

Task 11

![htb](/assets/SWS_pictures/htbf11.png)

Task 12 : Submit root flag

![htb](/assets/SWS_pictures/htbfflag.png)
...
![htb](/assets/SWS_pictures/htbd1.png)

Task 2: What port does SMB use to operate at?

![htb](/assets/SWS_pictures/htbd2n3.png)
...
![htb](/assets/SWS_pictures/htbd4.png)

Ans: -L

Task 5: How many shares are there on Dancing?

![htb](/assets/SWS_pictures/htbd5.png)

Ans: 4

Task 6

![htb](/assets/SWS_pictures/htbd6.png)

WorkShares is the only share without  value under the comment column. 

Task 7

![htb](/assets/SWS_pictures/htbd7.png)
...
We can login to workshares as it doesn't require a password, so i login to workshare.
 ...
 ![htb](/assets/SWS_pictures/htbd8a.png)
...
Command is nmap -p- -sV target_ip_address but it is taking time so to solve this issue i can ran this command : nmap -p- –min-rate 5000 -sV ip_address
 ...
 ![htb](/assets/SWS_pictures/htbr1n2.png)
...
Task 3
 ...
 ![htb](/assets/SWS_pictures/htbr3.png)

Task 4: Which command-line utility is used to interact with the Redis server? Enter the program name you would enter into the terminal without any arguments.

 ![htb](/assets/SWS_pictures/htbr4.png)
...
Task 5: Which flag is used with the Redis command-line utility to specify the hostname?
 ...
 ![htb](/assets/SWS_pictures/htbr5.png)

Ans: -h

Task 6

 ![htb](/assets/SWS_pictures/htbr6.png)

Task 7: What is the version of the Redis server being used on the target machine?

 ![htb](/assets/SWS_pictures/htbr7.png)
...
Task 8
 ...
 ![htb](/assets/SWS_pictures/htbr8.png)

Task 9: How many keys are present inside the database with index 0?

 ![htb](/assets/SWS_pictures/htbr9.png)
...
Task 10:  Which command is used to obtain all the keys in a database?
 ...
 ![htb](/assets/SWS_pictures/htbr11.png)
...
Task 11: Submit root flag
 ...
 ![htb](/assets/SWS_pictures/htbrflag.png)
...
Task 1
 ...
 ![htb](/assets/SWS_pictures/htbap1.png)

SQL is a standard language for accessing and manipulating databases

Task 2

 ![htb](/assets/SWS_pictures/htbap2.png)

SQL injection (SQLi) is a web security vulnerability that allows an attacker to interfere with the queries that an application makes to its database. This can allow an attacker to view data that they are not normally able to retrieve.

Task 3

 ![htb](/assets/SWS_pictures/htbap3.png)

Task 4: What does Nmap report as the service and version that are running on port 80 of the target?

 ![htb](/assets/SWS_pictures/htbap4.png)

Ans: Apache httpd 2.4.38 ((Debian))

Task 5: What is the standard port used for the HTTPS protocol?

 ![htb](/assets/SWS_pictures/htbap5.png)

Ans: 443

Task 6

 ![htb](/assets/SWS_pictures/htbap6.png)

Folders are also called "directories,"

Task 7

 ![htb](/assets/SWS_pictures/htbap7.png)

HTTP response status codes indicate whether a specific HTTP request has been successfully completed.

Task 8

 ![htb](/assets/SWS_pictures/htbap8.png)

Task 9

 ![htb](/assets/SWS_pictures/htbap9.png)
...
![htb](/assets/SWS_pictures/htbap10a.png)
...
Task 1: During our scan, which port do we find serving MySQL?
 ...
 ![htb](/assets/SWS_pictures/htbs1.png)

Ans: 3306

Task 2: What community-developed MySQL version is the target running?

 ![htb](/assets/SWS_pictures/htbs2.png)

Ans: MariaDB

Task 3

 ![htb](/assets/SWS_pictures/htbs3.png)

Task 4

 ![htb](/assets/SWS_pictures/htbs4.png)

Task 5

 ![htb](/assets/SWS_pictures/htbs5.png)

Task 6

 ![htb](/assets/SWS_pictures/htbs6.png)
...
With the username anonymous we can login anonymously. That’s what I did in task 3.
 ...
 ![htb](/assets/SWS_pictures/htbc4.png)

Task 5

 ![htb](/assets/SWS_pictures/htbc5.png)
...
Task 8
 ...
 ![htb](/assets/SWS_pictures/htbc8.png)

Task 9

 ![htb](/assets/SWS_pictures/htbc9.png)
...
To CTF, we should paste the machine ip address in the website followed by login.phh to land on the login page. (ip_address/login.php) 
 ...
 ![htb](/assets/SWS_pictures/htbc10a.png)
...
From the allowed.userlist we earlier found that username admin is high privilege, so we will use username admin. And the password is in allowed.userlist.passwd file.
 ...
 ![htb](/assets/SWS_pictures/htbc10b.png)

Password for user admin is rKXM59ESxesUFHAd.

 ![htb](/assets/SWS_pictures/htbcflag.png)
...
![htb](/assets/SWS_pictures/htbre1.png)

Ans: unika.htb

Task 2: Which scripting language is being used on the server to generate web pages?

 ![htb](/assets/SWS_pictures/htbre2.png)

Ans: php

Task 3

 ![htb](/assets/SWS_pictures/htbre3.png)

Task 4

 ![htb](/assets/SWS_pictures/htbre4.png)

Task 5

 ![htb](/assets/SWS_pictures/htbre5.png)

Task 6

 ![htb](/assets/SWS_pictures/htbre6.png)

Task 7

 ![htb](/assets/SWS_pictures/htbre7.png)

Task 8

 ![htb](/assets/SWS_pictures/htbre8.png)

Task 9: What is the password for the administrator user?

 ![htb](/assets/SWS_pictures/htbre9.png)
...
Task 10: We'll use a Windows service (i.e. running on the box) to remotely access the Responder machine using the password we recovered. What port TCP does it listen on?
 ...
 ![htb](/assets/SWS_pictures/htbre10.png)
